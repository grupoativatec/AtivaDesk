...
import { TaskStatus, TaskPriority, TaskUnit, TaskFilters as TaskFiltersType } from "./task.types"
      ...
      <div className="space-y-3">
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
            ...
            <div className="h-10 w-full sm:w-[110px] rounded-md border bg-background animate-pulse" />
            <div className="h-10 w-full sm:w-[160px] rounded-md border bg-background animate-pulse" />
          </div>
        </div>
      </div>
    )
