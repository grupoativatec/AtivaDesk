        ...
        <div className="px-4 sm:px-6 lg:px-8 xl:px-10 py-3 sm:py-4">
          ...
          <div className="grid grid-cols-4 gap-2 sm:gap-3 mb-4">
            <div className="bg-muted border border-border rounded-lg p-2 sm:p-2.5">
              ...
              <div className="text-lg sm:text-xl font-bold text-foreground">{stats.active}</div>
            </div>
            <div className="bg-muted border border-border rounded-lg p-2 sm:p-2.5">
              <div className="text-[10px] sm:text-xs text-muted-foreground font-medium mb-0.5">
                Arquivados
              </div>
              <div className="text-lg sm:text-xl font-bold text-foreground">{stats.archived}</div>
            </div>
            <div className="bg-muted border border-border rounded-lg p-2 sm:p-2.5">
              <div className="text-[10px] sm:text-xs text-muted-foreground font-medium mb-0.5">
                Com Tarefas
              </div>
              <div className="text-lg sm:text-xl font-bold text-foreground">{stats.withTasks}</div>
            </div>
            <div className="bg-muted border border-border rounded-lg p-2 sm:p-2.5">
              <div className="text-[10px] sm:text-xs text-muted-foreground font-medium mb-0.5">
                Total
